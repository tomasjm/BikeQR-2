...
const Index = () => {
  ...
  const { data } = api.storage.checkStorageProcess.useQuery({ storageId }, { refetchInterval: (checkingStorage) ? 1000 : 0 })
  ...
  const handleStartStorage = () => {
    mutation.mutate({ attendantId: "clihr51mm0000tyal6dqkg8yy", userId: "cligobmb80000ty4ejtwwmsek", bikeId: "cligobnps0003ty4e0wu3tvo5" })
  }
